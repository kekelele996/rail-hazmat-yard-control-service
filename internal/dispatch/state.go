...
var transitions = map[State]map[State]bool{
	StateQueued:   {StateMoving: true, StateHeld: true},
	StateMoving:   {StateCompleted: true, StateFailed: true},
	StateHeld:     {StateRetrying: true, StateFailed: true},
	StateRetrying: {StateMoving: true, StateCompleted: true, StateFailed: true},
}
